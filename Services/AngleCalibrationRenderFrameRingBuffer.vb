...
Namespace Services
    Friend Class AngleCalibrationRenderFrameRingBuffer
        Private ReadOnly _items() As AngleCalibrationRenderFrame
        ...
        Public Sub New(capacity As Integer)
            ...
            _items = New AngleCalibrationRenderFrame(capacity - 1) {}
        End Sub

        Public Sub Write(frame As AngleCalibrationRenderFrame)
        ...
        Public Function TryReadLatest(ByRef frame As AngleCalibrationRenderFrame) As Boolean
