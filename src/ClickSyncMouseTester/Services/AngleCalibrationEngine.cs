...
public class AngleCalibrationEngine
{
    ...
    private readonly List<List<MutableTracePoint>> _historicalStrokes;
    ...
    {
        _historicalStrokes = new List<List<MutableTracePoint>>();
    ...
    private IReadOnlyList<AngleCalibrationTraceStroke> CreateTraceSnapshots()
    {
        ...
        {
            AngleCalibrationTraceStroke historicalStroke = CreateStrokeSnapshot(_historicalStrokes[strokeIndex], isCurrent: false);
    ...
    private void ArchiveHistoricalStroke(List<MutableTracePoint> points)
    {
        ...
        List<MutableTracePoint> archivedPoints = new List<MutableTracePoint>(points.Count);
        foreach (MutableTracePoint point in points)
        {
            archivedPoints.Add(new MutableTracePoint(point.X, point.Y));
        }
        _historicalStrokes.Add(archivedPoints);
