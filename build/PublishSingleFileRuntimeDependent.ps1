...
$publishOutputDir = Join-Path $projectRoot ".artifacts\publish\win-x64-runtime-dependent-single-file\"
...
dotnet publish (Join-Path $projectRoot "ClickSyncMouseTester.vbproj") `
  -p:PublishProfile='Properties\PublishProfiles\SingleFileFdd-win-x64.pubxml' `
